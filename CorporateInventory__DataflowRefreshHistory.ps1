...
$ExportFile = 'C:\Users\PeacocCo\OneDrive - Coherent, Inc\Documents\GitHub\Inventory\dataflows\refresh_history\dataflow_refresh_history.csv'
...
try {
    ...
    $DataSets = Get-PowerBIDataflow -WorkspaceId $WorkspaceID
